...
public final class Constant {
	...
	public static final String SCHEMA_RECALL_ATTEMPT_COUNT = "SCHEMA_RECALL_ATTEMPT_COUNT";

	public static final String SCHEMA_RECALL_FAILURE_REASON = "SCHEMA_RECALL_FAILURE_REASON";
