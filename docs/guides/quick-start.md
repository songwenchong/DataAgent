...
> 关于如何关闭自动初始化，请参考 [开发者指南 - 数据库初始化配置](developer-guide.md#8-数据库初始化配置-database-initialization)。

### 2.3 配置模型

> 如果涉及手动管理模型依赖（非默认 Starter），请参考 [开发者指南 - 扩展依赖配置](developer-guide.md#9-扩展依赖配置-dependency-extension)。
...
> 详细配置参数请参考 [开发者指南 - 开发配置手册](developer-guide.md#⚙️-开发配置手册)。
...
> 关于如何替换默认的内存向量库（如使用 PGVector, Milvus 等），请参考 [开发者指南 - 扩展依赖配置](developer-guide.md#9-扩展依赖配置-dependency-extension)。
...
- 了解[架构设计](../architecture/architecture.md)以深入理解系统原理
- 查看[高级功能](advanced-features.md)了解更多高级特性
- 阅读[开发者文档](developer-guide.md)参与项目贡献
